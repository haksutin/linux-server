...
EDIT. poistin host-kohdasta `www`.
...
Sekä siirrtyin hakemistoon `/etc/apache2/sites-available/` ja loin LocalHost -tiedoston komennolla `sudoedit jennamaria.live.conf`.
...
Aikaa meni tähän tehtävään suhteellisen paljon kaikkien ongelmien kanssa ja sain kaiken tehtyä klo 19:15 ja raportin muokattua klo 19:48.
